...
from espnet.nets.lst_batch_beam_search import LSTBatchBeamSearch
from espnet.nets.waitk_batch_beam_search import WaitkBatchBeamSearch
from espnet.nets.beam_search import BeamSearch, Hypothesis
from espnet.nets.pytorch_backend.transformer.subsampling import TooShortUttError
from espnet.nets.scorer_interface import BatchScorerInterface
from espnet.nets.scorers.ctc import CTCPrefixScorer, CTCPrefixScorer_online
from espnet.nets.scorers.length_bonus import LengthBonus
from espnet.utils.cli_utils import get_commandline_args
from espnet2.asr.decoder.cif_decoder import CIFILDecoder
from espnet2.asr.decoder.lst_predictor import LSTPredictor
from espnet2.asr.decoder.waitk_decoder import WaitkDecoder
...
class Speech2Text:
    ...
    def __init__(
        ...
        stctc = CTCPrefixScorer_online(ctc=st_model.stctc, eos=st_model.eos)
        ...
        beam_search = BeamSearch(
            ...
            pre_beam_score_key=None,  # if stctc_weight == 1.0 else "full",
        )
        ...
        if batch_size == 1:
            ...
            if len(non_batch) == 0:
                ...
                if (
                    decoder.__class__ == LSTPredictor
                    or decoder.__class__ == CIFILDecoder
                ):
                    beam_search.__class__ = LSTBatchBeamSearch
                elif decoder.__class__ == WaitkDecoder:
                    beam_search.__class__ = WaitkBatchBeamSearch
                else:
