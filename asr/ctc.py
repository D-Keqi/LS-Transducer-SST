...
class CTC(torch.nn.Module):
    ...
    def __init__(
        ...
        # Last element has been used for AIF weight
    ...
    def forward(self, hs_pad, hlens, ys_pad, ys_lens):
        ...
        ys_hat = self.ctc_lo(F.dropout(hs_pad[:, :, :-1], p=self.dropout_rate))
    ...
    def softmax(self, hs_pad):
        ...
        """
        return F.softmax(self.ctc_lo(hs_pad[:, :, :-1]), dim=2)
    ...
    def log_softmax(self, hs_pad):
        ...
        """
        return F.log_softmax(self.ctc_lo(hs_pad[:, :, :-1]), dim=2)
    ...
    def argmax(self, hs_pad):
        ...
        """
        return torch.argmax(self.ctc_lo(hs_pad[:, :, :-1]), dim=2)
